...
If you have comments for how we could improve this material or presentation, we would be very grateful to hear feedback [by email](mailto:{{< var admin.email >}}) or through the [GitHub repository Issues page]({{< var github.issues >}}).
...
1. [Log in to Galaxy](join-session.qmd) at [https://usegalaxy.eu](https://usegalaxy.eu/)
...
- Register an account at the Galaxy instance: [link](https://usegalaxy.eu/login/start?redirect=None)
...
- [BM425 MyPlace formative quiz](https://classes.myplace.strath.ac.uk/mod/quiz/view.php?id=1295456)
- [BM932 MyPlace formative quiz](https://classes.myplace.strath.ac.uk/mod/quiz/view.php?id=1896407)
:::
