...
{{< video assets/movies/shovill-1.mp4 title="Genome assembly using `Shovill`" >}}
:::
...
{{< video assets/movies/bandage-1.mp4 title="Visualising the genome assembly with `Bandage Image`" >}}
:::
