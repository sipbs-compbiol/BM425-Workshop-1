...
2. How many SARS-CoV-2 SRA nucleotide sequence records can be found at NCBI?
:::
...
2. There are 9,197,015 SARS-CoV-2 nucleotide assemblies at NCBI (as of 2026-09-18)
:::
...
3. No genes are identified on the reverse strand (_there is no reverse strand to an RNA virus_)
4. Replicase polyprotein 1a is the product of the longest gene (13218 bases)
5. The product of the shortest non-hypothetical gene is protein 7a (366 bases)
6. `Prokka` v1.14.6
7. 21567..25388
:::