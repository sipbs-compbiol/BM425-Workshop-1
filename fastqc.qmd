# Sequence Read Quality {#sec-fastqc}
...
{{< video assets/movies/fastqc-1.mp4 title="Assessing sequencing read quality with `FastQC`" >}}
:::
...
{{< video assets/movies/fastqc-2.mp4 title="Inspecting `FastQC` output in Galaxy" >}}
:::
