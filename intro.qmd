...
![Early COVID-19 global spread](assets/images/COVID-19-outbreak-timeline-2.gif){#fig-spread fig-alt="Animated .gif showing the global spread of COVID-19 from China in early January 2020, to most of the Northern hemisphere by the end of February 2020." width=80% .lightbox}
...
![JBrowse rendering of an annotated SARS-CoV-2 genome](assets/images/spike_vis_jbrowse.png){#fig-jbrowse-1 fig-alt="JBrowse view of an annotated SARS-CoV-2 assembly, showing the location of the spike (S) protein on the genome." .lightbox}
...
![How SARS-CoV-2 interacts with the surface proteins of the target cell [(Marta Palma Rodríguez)](https://pdb101.rcsb.org/news/5ed7c17cdab5c9354c274f56)](assets/images/sars-ace2tmprs2-martapalma.png){#fig-palma fig-alt="Schematic representation of SARS-CoV-2 surface proteins and their interactions with the host." width=80% .lightbox}
...
::: { .callout-tip }
## Click on these links to download the data.
