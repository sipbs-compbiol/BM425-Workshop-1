...
::: { .callout-warning }
You will need to clean the `ERR4164769` read set with a tool called `fastq groomer`. This will transform the read file into the correct format for use with the tools you have learned about today.

**If you do not use `fastq groomer` you will meet with errors in the workflow**
:::
...
- [BM425 link](https://classes.myplace.strath.ac.uk/mod/quiz/view.php?id=1295456)
- [BM932 link](https://classes.myplace.strath.ac.uk/mod/quiz/view.php?id=1896407)
:::