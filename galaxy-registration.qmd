...
::: { .callout-tip }
## Register with `usegalaxy.org`

The first action you should take in this workshop, if you do not already have an account at [https://usegalaxy.org/](https://usegalaxy.org/), is to **create an account at [https://usegalaxy.org/](https://usegalaxy.org/)**.
:::

1. Go to the Galaxy [login/registration page](https://usegalaxy.org/login/start?redirect=None)
2. If you have a `usegalaxy.org` account already, then log in using your details and move on to the workshop proper.
3. If you do not already have a `usegalaxy.org` account, then **click on the `Register here` link**.
