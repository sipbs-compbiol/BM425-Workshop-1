...
When the `JBrowse` output in the `History` sidebar is complete, click on the `eye` (`View`) icon to bring the visualisation to the main `Workspace` area. Watch the video below to see some of the features of the visualisation in action.
